  ...
  return (
    <ModalRoot onCancel={closeModal}>
      <div style={{ display: "flex", flexDirection: "column" }}>
        <DialogHeader>{id === undefined ? "Add" : "Modify"}</DialogHeader>
        <Field label="label" padding="none" bottomSeparator="none">
          <Focusable
            style={{
              boxShadow: "none",
              display: "flex",
        ...
        <Field label="Field & Value" padding="none" bottomSeparator="none">
          <Focusable
            style={{
              boxShadow: "none",
              display: "flex",
