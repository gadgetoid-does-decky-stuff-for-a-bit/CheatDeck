  ...
  return (
    <PanelSection title="informatin">
      ...
      >
        <DialogBodyText>
          <p>
            <b>CheatDeck only support the normal steam launcher for now.</b>
          </p>
          ...
          <li>
            If you are unable to click the selected cheat panel, please turn the
            game to window mode.
          </li>
        </DialogBodyText>
      </Focusable>
        ...
        >
          <Focusable style={{ display: "flex" }}>
            <DialogButton
              ...
              onSecondaryButton={() =>
                showQrModal("https://github.com/SheffeyG/CheatDeck")
              }
